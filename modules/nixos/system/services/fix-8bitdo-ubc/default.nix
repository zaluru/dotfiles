...
let
  ...
  cfg = config.mine.system.services.fix-8bitdo-ubc;

in
{
  options.mine.system.services.fix-8bitdo-ubc = {
    enable = mkEnableOption "Enable udev rule and xboxdrv daemon to fix 8bitdo Ultimate Bluetooth controller";
  };
